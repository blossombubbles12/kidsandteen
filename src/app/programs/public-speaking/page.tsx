...
import { Mic, ArrowRight, Sparkles, Quote, BookOpen, UserCheck, Globe } from "lucide-react";
import { getFolderImages } from "@/app/actions/media";
import Image from "next/image";

export const metadata: Metadata = {
    title: "Public Speaking Program | Kids and Teens University (KTU)",
    description: "We raise a generation of confident voices, bold thinkers, and inspiring speakers at KTU.",
};
                ...
                <div className="container px-4 md:px-6 relative z-10">
                    <div className="max-w-3xl mx-auto text-center">
                        <span className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-white/15 backdrop-blur-sm border border-white/25 text-sm font-semibold mb-4">
                            <Mic className="w-4 h-4" /> Program
                        </span>
                        <h1 className="text-5xl md:text-7xl font-black mb-4 tracking-tight">
                            Public <span className="text-[#e50a1e]">Speaking</span>
                        </h1>
                        <p className="text-2xl md:text-3xl font-bold text-white/90 leading-relaxed">
                            The future is speaking&hellip; and it&apos;s <span className="text-[#e50a1e]">powerful</span>.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 container px-4 md:px-6">
                <div className="max-w-3xl mx-auto">
                    <p className="text-lg text-[#545454] font-semibold leading-relaxed mb-12">
                        At Kids &amp; Teens University, we are raising a generation of confident voices, bold thinkers, and inspiring speakers. Our children are not just learning to speak&mdash;they are learning to influence, lead, and create impact.
                    </p>

                    {/* Feature Cards */}
                    <div className="grid md:grid-cols-3 gap-6 mb-12">
                        {[
                            { icon: BookOpen, title: "Structured Training", desc: "Step-by-step curriculum designed to build confidence and clarity in communication." },
                            { icon: UserCheck, title: "Expert Mentorship", desc: "Learn from experienced speakers, coaches, and communication professionals." },
                            { icon: Globe, title: "Real-Stage Exposure", desc: "From classroom practice to global platforms, every child gets their moment." },
                        ].map((item) => (
                    ...
                    <div className="bg-white p-8 md:p-10 rounded-[2.5rem] border-2 border-[#e50a1e]/20 shadow-sm">
                        <p className="text-lg text-[#545454] font-semibold leading-relaxed mb-6">
                            Through structured training, mentorship, and real-stage exposure, we equip kids and teens with the confidence to stand tall, share their ideas, and communicate with clarity and purpose. Every child has a voice, and we make sure it is heard.
                        </p>
                        <p className="text-lg text-[#545454] font-semibold leading-relaxed mb-6">
                            From classroom practice to global platforms, we are shaping communicators who will drive change, inspire communities, and lead the future.
                        </p>
                        <div className="relative p-6 md:p-8 bg-gradient-to-br from-[#e50a1e]/5 to-[#cc0000]/5 rounded-2xl border border-[#e50a1e]/15 text-center">
                            ...
                            <p className="text-xl md:text-2xl font-black text-[#e50a1e] relative z-10">Today&apos;s young speaker&hellip; tomorrow&apos;s world leader.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <section className="py-20 bg-white">
                    <div className="container px-4 md:px-6">
                        <div className="text-center mb-12">
                            ...
                            <h2 className="text-3xl md:text-4xl font-black text-[#1a1a1a]">Our Speakers in Action</h2>
                        </div>
            ...
            <section className="py-24 relative overflow-hidden bg-gradient-to-br from-[#e50a1e] to-[#cc0000] text-white">
                ...
                <div className="container px-4 md:px-6 text-center relative z-10">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <h2 className="text-3xl md:text-5xl font-black mb-4">Ready to Find Your Voice?</h2>
                        <p className="text-lg text-white/80 font-semibold mb-8">Every child has a voice. We make sure it&apos;s heard.</p>

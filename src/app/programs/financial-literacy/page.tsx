...
export const metadata: Metadata = {
    title: "Financial Literacy Program | Kids and Teens University (KTU)",
    description: "Teaching kids and teens how money works — earning, saving, budgeting, and smart financial decisions.",
};
                ...
                <div className="container px-4 md:px-6 relative z-10">
                    <div className="max-w-3xl mx-auto text-center">
                        <span className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-white/15 backdrop-blur-sm border border-white/25 text-sm font-semibold mb-4">
                            <DollarSign className="w-4 h-4" /> Program
                        </span>
                        <h1 className="text-5xl md:text-7xl font-black mb-4 tracking-tight">
                            Financial <span className="text-[#e50a1e]">Literacy</span>
                        </h1>
                        <p className="text-2xl md:text-3xl font-bold text-white/90 leading-relaxed">
                            Why kids and teens should learn <span className="text-[#e50a1e]">finance early</span>.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 container px-4 md:px-6">
                <div className="max-w-3xl mx-auto">
                    <p className="text-lg text-[#545454] font-semibold leading-relaxed mb-12">
                        Learning about finance helps kids and teens understand how money works in real life&mdash;how it is earned, saved, spent, and managed. It builds strong habits early, such as budgeting, saving for goals, and making thoughtful choices instead of impulsive spending.
                    </p>
                    ...
                    <div className="bg-white p-8 md:p-10 rounded-[2.5rem] border-2 border-[#545454]/20 shadow-sm space-y-6">
                        <p className="text-lg text-[#545454] font-semibold leading-relaxed">
                            Understanding finance also teaches responsibility and independence. It helps young people learn the difference between needs and wants, and how to plan ahead for things they care about.
                        </p>
                        <p className="text-lg text-[#545454] font-semibold leading-relaxed">
                            Programs like Kids and Teens University make financial education simple, practical, and engaging. They guide students through real-life money skills like managing allowances, setting savings goals, and understanding basic financial decisions.
                        </p>
                        <div className="relative p-6 md:p-8 bg-gradient-to-br from-[#545454]/5 to-[#888888]/5 rounded-2xl border border-[#545454]/15 text-center">
                            ...
                            <p className="text-lg font-bold text-[#545454] relative z-10">
                                When kids and teens learn about finance early, they become more confident and better prepared for the future. These skills not only help with money, but also with decision-making, discipline, and planning for success in adulthood.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] to-[#000000] text-white">
                ...
                <div className="container px-4 md:px-6 text-center relative z-10">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <h2 className="text-3xl md:text-5xl font-black mb-4">Start Building Smart Money Habits</h2>
                        <p className="text-lg text-white/80 font-semibold mb-8">Give your child the financial head start they deserve.</p>

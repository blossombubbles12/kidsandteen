...
export const metadata: Metadata = {
    title: "Boardroom Leadership Program | Kids and Teens University (KTU)",
    description: "Grooming young minds to think, speak, and lead with confidence in professional environments.",
};

export const dynamic = 'force-dynamic';

export default async function BoardroomLeadershipPage() {
                ...
                <div className="container px-4 md:px-6 relative z-10">
                    <div className="max-w-3xl mx-auto text-center">
                        <span className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-white/15 backdrop-blur-sm border border-white/25 text-sm font-semibold mb-4">
                            <Briefcase className="w-4 h-4" /> Program
                        </span>
                        <h1 className="text-5xl md:text-7xl font-black mb-4 tracking-tight">
                            Boardroom <span className="text-[#e50a1e]">Leadership</span>
                        </h1>
                        <p className="text-2xl md:text-3xl font-bold text-white/90 leading-relaxed">
                            The boardroom is no longer just for adults&hellip; the future is already <span className="text-[#e50a1e]">taking a seat</span>.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 container px-4 md:px-6">
                <div className="max-w-3xl mx-auto">
                    <p className="text-lg text-[#545454] font-semibold leading-relaxed mb-12">
                        At Kids &amp; Teens University, we are grooming young minds to think, speak, and lead with confidence. Dressed for excellence and ready for impact, these young leaders are learning how to communicate ideas, make decisions, and collaborate in professional environments.
                    </p>
                    ...
                    <div className="bg-white p-8 md:p-10 rounded-[2.5rem] border-2 border-[#e50a1e]/20 shadow-sm">
                        <p className="text-lg text-[#545454] font-semibold leading-relaxed mb-6">
                            It&apos;s more than just looking the part&mdash;it&apos;s about building the mindset, discipline, and leadership skills required to thrive in the real world. From presentations to strategic thinking, we are preparing them early for global relevance.
                        </p>
                        <div className="relative p-6 md:p-8 bg-gradient-to-br from-[#e50a1e]/5 to-[#cc0000]/5 rounded-2xl border border-[#e50a1e]/15 text-center">
                            ...
                            <p className="text-xl md:text-2xl font-black text-[#e50a1e] relative z-10">Today, they sit at the table&hellip; tomorrow, they lead it.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <section className="py-20 bg-white">
                    <div className="container px-4 md:px-6">
                        <div className="text-center mb-12">
                            ...
                            <h2 className="text-3xl md:text-4xl font-black text-[#1a1a1a]">Future Leaders in Action</h2>
                        </div>
            ...
            <section className="py-24 relative overflow-hidden bg-gradient-to-br from-[#e50a1e] to-[#cc0000] text-white">
                ...
                <div className="container px-4 md:px-6 text-center relative z-10">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <h2 className="text-3xl md:text-5xl font-black mb-4">Ready to Take a Seat at the Table?</h2>
                        <p className="text-lg text-white/80 font-semibold mb-8">Prepare your child to lead with confidence in any room.</p>

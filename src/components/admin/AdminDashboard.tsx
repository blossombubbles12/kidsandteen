...
export default function AdminDashboard({ initialRegistrations, stats, user }: AdminDashboardProps) {
    ...
    const [activeTab, setActiveTab] = useState<'registrations' | 'media'>('registrations');
        ...
        <div className="p-6 md:p-10 max-w-7xl mx-auto space-y-10">
            ...
            <div className="flex gap-2 border-b border-border">
                <button
                    ...
                    className={`px-6 py-3 font-bold uppercase tracking-wider text-sm transition-all relative ${activeTab === 'registrations'
                            ? 'text-primary'
                ...
                <button
                    ...
                    className={`px-6 py-3 font-bold uppercase tracking-wider text-sm transition-all relative ${activeTab === 'media'
                            ? 'text-primary'
                            : 'text-muted-foreground hover:text-slate-900'
                        }`}
                >

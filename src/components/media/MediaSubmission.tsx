    ...
    const handleUpload = async (e: React.FormEvent) => {
        ...
        try {
            const targetFolder = folderName.trim()
                ...
                : "ktuafrica/community_submissions";
            ...
            <div className="container px-4 text-center max-w-3xl mx-auto">
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">Share Your KTU Moment</h2>
                        <p className="text-lg text-muted-foreground mb-10">
                            Captured a special moment at one of our programs? We'd love to feature it in our community gallery!
                        </p>
                                    ...
                                    <div className="py-6 px-1 space-y-6 max-h-[60vh] overflow-y-auto no-scrollbar">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                <Input
                                                    id="folder"
                                                    placeholder="e.g. ktuafrica/events or just programs"
                                            ...
                                            <p className="text-[11px] text-muted-foreground ml-1">
                                                Select existing or type new path (e.g. 'ktuafrica/new_album'). Leave empty for general view.
                                            </p>
                                        </div>
                                    </div>
